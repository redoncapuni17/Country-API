...
export default function Menu({
  ...
  return (
    <main
      className={`bg-gray-100  duration-300 ${
        darkMode && "bg-gray-800 duration-300"
      }`}
    >
      ...
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  gap-16 xl:px-20 lg:px-16 md:px-10 sm:px-10 px-5 pb-10">
        {searchedCountry.slice(0, 8).map((country) => (
          <li
            key={country.cca3}
            className={`border rounded-md w-72 bg-white shadow-md list-none overflow-hidden duration-300  ${
              darkMode &&
